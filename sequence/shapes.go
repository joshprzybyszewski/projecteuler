...
var (
	...
	Square     ShapeSequence = newShapeSequenceCache(square)
	Pentagonal ShapeSequence = newShapeSequenceCache(pentagon)
	Hexagonal  ShapeSequence = newShapeSequenceCache(hexagon)
	Heptagonal ShapeSequence = newShapeSequenceCache(heptagon)
	Octagonal  ShapeSequence = newShapeSequenceCache(octagon)
)
