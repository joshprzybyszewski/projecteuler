...
import (
	...
	"github.com/joshprzybyszewski/projecteuler/easy/primeconcat"
	"github.com/joshprzybyszewski/projecteuler/mathUtils"
)

func SolveProblem60() string {
	/*
		The primes 3, 7, 109, and 673, are quite remarkable. By
		taking any two primes and concatenating them in any order
	...
	*/
	ans := primeconcat.NewAllSets().GetMinSet(5)
